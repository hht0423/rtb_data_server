...
public class RtbPortrait {

  public interface Iface {

    public void ping() throws org.apache.thrift.TException;

    public RtbUserPortraitResp getUserInfo(RtbUserPortraitReq req) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getUserInfo(RtbUserPortraitReq req, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_getUserInfo(RtbUserPortraitReq req) throws org.apache.thrift.TException
    {
    ...
    public RtbUserPortraitResp recv_getUserInfo() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getUserInfo_call extends org.apache.thrift.async.TAsyncMethodCall {
      private RtbUserPortraitReq req;
      ...
      public RtbUserPortraitResp getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getUserInfo<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getUserInfo_args, RtbUserPortraitResp> {
      public getUserInfo() {
        super("getUserInfo");
      }
      ...
      public AsyncMethodCallback<RtbUserPortraitResp> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<RtbUserPortraitResp>() { 
          public void onComplete(RtbUserPortraitResp o) {
            getUserInfo_result result = new getUserInfo_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getUserInfo_args args, org.apache.thrift.async.AsyncMethodCallback<RtbUserPortraitResp> resultHandler) throws TException {
...
;
  ...
  public static class getUserInfo_args implements org.apache.thrift.TBase<getUserInfo_args, getUserInfo_args._Fields>, java.io.Serializable, Cloneable, Comparable<getUserInfo_args>   {
    ...
    public RtbUserPortraitReq req; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.REQ, new org.apache.thrift.meta_data.FieldMetaData("req", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, RtbUserPortraitReq.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public getUserInfo_args(getUserInfo_args other) {
      if (other.isSetReq()) {
        this.req = new RtbUserPortraitReq(other.req);
      }
    }
    ...
    public RtbUserPortraitReq getReq() {
      return this.req;
    }

    public getUserInfo_args setReq(RtbUserPortraitReq req) {
      this.req = req;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case REQ:
        if (value == null) {
          ...
          setReq((RtbUserPortraitReq)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case 1: // REQ
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.req = new RtbUserPortraitReq();
  ...
  public static class getUserInfo_result implements org.apache.thrift.TBase<getUserInfo_result, getUserInfo_result._Fields>, java.io.Serializable, Cloneable, Comparable<getUserInfo_result>   {
    ...
    public RtbUserPortraitResp success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, RtbUserPortraitResp.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public getUserInfo_result(getUserInfo_result other) {
      if (other.isSetSuccess()) {
        this.success = new RtbUserPortraitResp(other.success);
      }
    }
    ...
    public RtbUserPortraitResp getSuccess() {
      return this.success;
    }

    public getUserInfo_result setSuccess(RtbUserPortraitResp success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((RtbUserPortraitResp)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getUserInfo_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new RtbUserPortraitResp();
